...
public class MainMenuLayout extends Table implements Layout, Localizable, ConnectedI, DisconnectedI {
	...
	private void createElements () {
		...
		//connectionBtn = new TextButton("", skin, "big");
	...
	private void initLayout () {
		...
		//buttonsTable.add(connectionBtn).padBottom(20);
		//buttonsTable.row();
		...
		setFillParent(true);
        add(connectionStatusLabel).padTop(5);
        row();
	...
	private void createListeners () {
		/*
		connectionBtn.addListener(new ClickListener() {
				public void clicked (InputEvent event, float x, float y) {
					context.getLayoutManager().show(AuthLayout.NAME);
		...
		*/
		...
		addListener(new InputListener() {
				public boolean keyDown (InputEvent event, int keycode) {
					if ((keycode == Input.Keys.BACK || keycode == Input.Keys.ESCAPE) && context.getLayoutManager().thisIsActiveLayout(MainMenuLayout.this)) {
	...
	@Override
	public void online () {
		//connectionBtn.setDisabled(true);
	...
	@Override
	public void offline () {
		//connectionBtn.setDisabled(false);
		//connectionBtn.setVisible(true);
		startGameBtn.setDisabled(true);
		connectionIndicatorCheckBox.setChecked(false);
	}
	...
	public void applyLocale (I18NBundle bundle) {
		...
		//connectionBtn.setText(bundle.get("ConnectionBtn"));
